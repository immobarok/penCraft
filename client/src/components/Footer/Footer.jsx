...
const Footer = () => {
  return (
    <>
      <footer className="px-6 md:px-12 lg:px-16 xl:px-20 w-full border-t mt-10 border-purple-600/10">
        <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">
          <div className="max-w-96">
            <div className='flex gap-2 items-center cursor-pointer'>
              <img onClick={Navigate('/')} src={assets.logo} alt="" className='w-20 sm:w-10' />
              <p className='text-2xl font-bold bg-gradient-to-l to-[#eb3af3] from-[#794ffb] hover:from-blue-600/50 bg-clip-text text-transparent'>PENCRAFT</p>
            </div>
        ...
        <p className="py-4 text-center text-xs md:text-sm text-gray-500">
          Copyright {new Date().getFullYear()} © pencraft. All Right Reserved.
        </p>
      </footer>
    </>
  )
